...
public class task1{
	...
	public static void main(String...args) {
		String[] names = {"Nikita", "Elena", "Thomas", "Hamilton", "Suzie", "Phil", "Matt", "Alex", "Emma", "John", "James", "Jane", "Emily", "Daniel", "Neda", "Aaron", "Kate" };
		int[] times = {11, 341, 273, 278, 329, 445, 402, 388, 275, 243, 334, 412, 393, 299, 343, 317, 265 };
		int top1=0;
		int top2= times[0]<times[1]?1:0;
		for(int i=1;i<times.length;i++){
			if (times[i]<times[top2]){
				top2=i;
